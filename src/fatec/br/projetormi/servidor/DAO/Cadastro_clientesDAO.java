...
//------------ Metodos ------------
    ...
    public boolean cadastrarCli(Cadastro_clientesVO obj) throws SQLException {
        /**
         * @param nome nome a ser inserido na coluna nomeCli da tabela
         * "tabCliente"
         * @param cpf cpf a ser inserido na coluna cpfCli da tabela "tabCliente"
         * @param data data a ser inserido na coluna dataCli da tabela
         * "tabCliente"
         * @param telefone telefone a ser inserido na coluna telCli da tabela
         * "tabCliente"
         * @param status status a ser inserido na coluna statusCli da tabela
         * "tabCliente"
         *
         * Este metodo cadastra na tabela "tabCliente" do banco de dados
         * "LeilaoRMI" os dados passados por paramentro
         */
    ...
    public boolean editarCli(Cadastro_clientesVO obj) throws SQLException {
        /**
         * @param nome nome a ser alterado na coluna nomeCli da tabela
         * "tabCliente"
         * @param cpf cpf a ser alterado na coluna cpfCli da tabela "tabCliente"
         * @param data data a ser alterado na coluna dataCli da tabela
         * "tabCliente"
         * @param telefone telefone a ser alterado na coluna telCli da tabela
         * "tabCliente"
         * @param status status a ser alterado na coluna statusCli da tabela
         * "tabCliente"
         *
         * Este metodo altera os dados na tabela "tabCliente" do banco de dados
         * "LeilaoRMI" referente aos dados passados por parametro
         */
        conexao.abrir(); //Abre a conexao com o banco
    ...
    public void deletarCli(String cpf) throws SQLException {
         ...
         *
         * Este metodo deleta o conteudo da tabela "tabCliente" no banco de
         * dados "LeilaoRMI" referente ao String digitado em txtCpf
         */
        conexao.abrir(); //Abre a conexao com o banco
