 ...
 */
public class AutentificacaoFuncionarioDAO {
    ...
    private AutentificacaoFuncionarioVO autentificacaoVO = null;

    public AutentificacaoFuncionarioDAO(Conexao conexao) {
        /**
    ...
    public AutentificacaoFuncionarioVO validarSenha(String email, String senha) throws SQLException {
        /**
        ...
        sql = "select * from TABFUNCIONARIO where email_cliente = ? and senha_cliente = ?"; //Comando SQL para busca
        ...
        {
            autentificacaoVO = new AutentificacaoFuncionarioVO(); //Instancia um novo objeto ClienteVO 
            //dados pessoais
